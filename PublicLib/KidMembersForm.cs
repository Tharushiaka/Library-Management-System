...
namespace PublicLib
{
    ...
    public partial class KidMembersForm : Form
    {
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            {
                Con.Open();
                string query = "update C_Reader set UserID='" + UserID.Text + "',FtName='" + FName.Text + "',LtName='" + LName.Text + "',Gender='" + Gender.Text + "',Address='" + Address.Text + "' where UserID =" + UserID.Text + ";";
